...
import { createCalibrationRecord } from '../../../redux/slice/calibrationSlice';
...
function AddCalibrationForm({ handleClose }) {
    ...
    useEffect(() => {
        ...
        setFormData(prev => ({
            ...prev,
            calibration_code: `CL-${timestamp}-${random}`
        }));
    }, [dispatch, assets]);
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            await dispatch(createCalibrationRecord(submitData)).unwrap();
            
            // Show success message
            setSuccessMessage('Tạo lịch hiệu chuẩn thành công!');
            setShowSuccess(true);
