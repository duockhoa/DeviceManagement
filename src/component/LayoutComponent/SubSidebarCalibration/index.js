...
function SubSidebarCalibration() {
    ...
    const resultOptions = [
        ...
        { value: 'fail', label: 'Không đạt', color: 'error' },
        { value: 'pending', label: 'Chờ kết quả', color: 'warning' }
    ];
        ...
        >
            ...
            <Box sx={{ p: 2, borderBottom: '1px solid #e0e0e0', backgroundColor: '#fff' }}>
                ...
                <TextField
                    fullWidth
                    size="small"
                    placeholder="Tìm kiếm hiệu chuẩn..."
                    value={searchTerm}
            ...
            <Box sx={{ flex: 1, overflow: 'auto', p: 1 }}>
                ...
                {/* Result Filter */}
                <Accordion
                    expanded={openSections.result}
                    onChange={() => toggleSection('result')}
                    sx={{ mb: 1, boxShadow: 'none', border: '1px solid #e0e0e0' }}
                >
                    <AccordionSummary expandIcon={<ExpandMore />}>
                        <Typography variant="subtitle2" sx={{ fontWeight: 'bold' }}>
                            ...
                            <FormControlLabel
                                ...
                                control={
                                    <Checkbox
                                        ...
                                        onChange={() => handleFilterChange('result', option.value)}
                                    />
                                }
                                label={
                                    <Chip
...
export default SubSidebarCalibration;